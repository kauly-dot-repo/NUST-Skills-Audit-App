...
function OtherReports() {
  ...
  function filterSkill() {
    ...
    axios.post(API_URL + '/filter-by-skillname', { skillName, department })
      .then((response) => {
  ...
  useEffect(() => {
    axios.get(`${API_URL}/get-by-department/${localStorage.getItem('department')}`)
      .then(response => {
        ...
        <Container>
          <div>
            <Typography variant='h2' align='center'>
              Draw Reports for the <br />
              <span style={emphasisStyle}>{localStorage.getItem('department')}</span>
              <br />  
            </Typography>
            ...
            Show CSV export content text
                ...
                <div>
                  <form>
                    <Grid container spacing={1} align='center' style={{ padding: '15px' }}>
                      ...
                      <TextField
                          ...
                          variant='filled' value={localStorage.getItem('department')}
                        />
                      </Grid>
                      ...
                      <Grid item xs={12} md={2} lg={3}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'row' }}>
                          <Button
                            style={{ height: '100%', margin: '5px', padding: '14.5px' }}
                            variant='contained'
                            color='primary'
                            onClick={filterSkill}
                          >
                          ...
                          >
                            <Button variant="contained" color="secondary" style={{ height: '100%', margin: '5px', padding: '26px' }}>
                              Download CSV
                            </Button>
                          </CSVLink>
                        </Box>
