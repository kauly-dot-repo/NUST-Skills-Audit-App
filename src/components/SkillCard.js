...
function SkillCard(props) {
  ...
  function editSkill() {
    if (props.skill_type == "Field Specific") {
      ...
      axios.post(API_URL + '/update-field-rating', {
      ...
      axios.post(API_URL + '/update-job-rating', {
        staffnumber: localStorage.getItem('staffnumber'),
        skill_name: skillObject.skill_name,
        emp_rating: skillLevel,
      }).then((response) => {
      ...
      axios.post(API_URL + '/update-soft-rating', {
        staffnumber: localStorage.getItem('staffnumber'),
        skill_name: skillObject.skill_name,
        emp_rating: skillLevel,
      }).then((response) => {
      ...
      axios.post(API_URL + '/update-other-rating', {
        staffnumber: localStorage.getItem('staffnumber'),
        skill_name: skillObject.skill_name,
        emp_rating: skillLevel,
      }).then((response) => {
  ...
  function supervisorRating() {
    if (props.skill_type == "Field Specific") {
      ...
      axios.post(API_URL + '/supervisor-field-rating', {
      ...
      axios.post(API_URL + '/supervisor-job-rating', {
        staffnumber: subNumber,
        skill_name: skillObject.skill_name,
        sup_rating: supRating,
      }).then((response) => {
      ...
      axios.post(API_URL + '/supervisor-soft-rating', {
        staffnumber: subNumber,
        skill_name: skillObject.skill_name,
        sup_rating: supRating,
      }).then((response) => {
  ...
  function deleteSkill(e) {
    ...
    if (props.skill_type == "Field Specific") {
      console.log("I'm in Field Skills!!!")
      axios.post(API_URL + '/delete-field-skill', {
        staffnumber: localStorage.getItem('staffnumber'),
        skill_name: skillObject.skill_name,
        emp_rating: skillLevel,
      ...
      console.log("I'm in Job Skills!!!")
      axios.post(API_URL + '/delete-job-skill', {
        staffnumber: localStorage.getItem('staffnumber'),
        skill_name: skillObject.skill_name,
        emp_rating: skillLevel,
        sup_rating: skillObject.sup_rating
      ...
      console.log("I'm in Soft Skills!!!")
      axios.post(API_URL + '/delete-soft-skill', {
        staffnumber: localStorage.getItem('staffnumber'),
        skill_name: skillObject.skill_name,
        emp_rating: skillLevel
        // sup_rating: skillObject.sup_rating
      ...
      console.log("I'm in Other Skills!!!")
      axios.post(API_URL + '/delete-other-skill', {
        staffnumber: localStorage.getItem('staffnumber'),
        skill_name: skillObject.skill_name,
        emp_rating: skillLevel,
        sup_rating: skillObject.sup_rating
