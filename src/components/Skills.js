...
function Skills(props) {
  ...
  function skillSubmitHandler() {
    ...
    if (props.skillType == "Field Specific") {
      ...
      axios.post(API_URL + '/new-field-skill', {
      ...
      axios.post(API_URL + '/new-job-skill', {
        staffnumber: localStorage.getItem('staffnumber'),
        skill_name: skillname,
        emp_rating: skillLevel,
      }).then((response) => {
      ...
      axios.post(API_URL + '/new-soft-skill', {
        staffnumber: localStorage.getItem('staffnumber'),
        skill_name: skillname,
        emp_rating: skillLevel,
      }).then((response) => {
      ...
      axios.post(API_URL + '/new-other-skill', {
        staffnumber: localStorage.getItem('staffnumber'),
        skill_name: skillname,
        emp_rating: skillLevel,
      }).then((response) => {
